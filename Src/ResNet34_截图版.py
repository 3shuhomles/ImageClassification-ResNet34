...
numpy.expand_dims(numpy数组,扩维轴的下标)
numpy.rollaxis(numpy数组,需边换轴的下标,变换后轴的下标)
numpy,squeeze(numpy数组,需减少的维度下标) #当维度对应值只有一个且为1时才可降维
