...
EPOCHES = 1
LEARNINGRATE = 0.001
NAME = f'ResNet18_{EPOCHES}_{LEARNINGRATE}'
SEED = 45
...
# pltsave_str = f".\dataset\model_figure\Loss_and_CategoricalAccuracy_{EPOCHES}.png"
'''history曲线'''
...
plt.savefig(fname=f".\dataset\model_figure\Loss_and_CategoricalAccuracy_{NAME}.png",figsize=[10,10])
plt.show()
